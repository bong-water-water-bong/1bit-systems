//! 1bit-halo-pkg — plugin package manager for Helm.
//!
//! Implements the client side of the plugin system spec'd in
//! `1bit-halo-core/docs/wiki/Helm-Plugin-API.md` (v0.1).
//!
...
//!   `~/.local/share/1bit-halo-pkg/plugins/<name>/`.
//!
//! The `1bit-halo-pkg` binary ([`crate::main`](../main/index.html)) is a thin
