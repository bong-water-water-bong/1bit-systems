...
//! mirror the algorithm in SQLite so halo-agents stays zero-dep beyond
...
//!
//! See `docs/wiki/Crate-halo-agents-dialectic.md` for the deviation matrix
...
/// `docs/wiki/Crate-halo-agents-dialectic.md#derivation-prompt` (to be
