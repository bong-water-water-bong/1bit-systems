//! `skill_manage` MCP tool — exposes the 1bit-agents skill
...
//! translates JSON arguments into a [`onebit_agents::SkillAction`] and calls
//! [`onebit_agents::skills::tool::apply`] against a shared
//! [`onebit_agents::SkillStore`].
//!
//! # Why a separate module
//!
//! The 17 specialists come from `onebit_agents::Name::ALL` and are routed
...
use onebit_agents::{Skill, SkillAction, SkillStore, skills::tool::apply};
