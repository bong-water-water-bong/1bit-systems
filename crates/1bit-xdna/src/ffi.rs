...
unsafe extern "C" {
    pub(crate) fn onebit_xrt_open(bdf_idx: u32) -> *mut HaloXrtDevice;
    pub(crate) fn onebit_xrt_close(dev: *mut HaloXrtDevice);
    pub(crate) fn onebit_xrt_load_xclbin(dev: *mut HaloXrtDevice, path: *const c_char) -> c_int;
    pub(crate) fn onebit_xrt_run_kernel(
