...
use clap::Subcommand;
use onebit_agents::skills::{Skill, SkillStore};
...
/// Mirrors 1bit-agents' internal `find_path` but stays inside the public
...
/// always calls `run`, but 1bit-cli's integration tests (and anyone
