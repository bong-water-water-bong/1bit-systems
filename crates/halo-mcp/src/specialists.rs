...
//!
//! The canonical list of specialists lives in `halo_agents::Name::ALL` —
...
//! `halo-agents` guarantees the MCP bridge and the dispatch registry
...
/// this keeps us building if `halo-agents` grows the enum before we update
/// this table.
