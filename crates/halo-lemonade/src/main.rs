//! halo-lemonade binary — OpenAI-compat model gateway.
//!
//! v0 scope: serve /v1/models from a TOML registry and /_health. Actual
//! chat/completions forwarding lands when halo-router's client API is
    ...
    tracing_subscriber::fmt()
        .with_env_filter(
            tracing_subscriber::EnvFilter::try_from_default_env()
                .unwrap_or_else(|_| "halo_lemonade=info".into()),
        )
        .with_target(false)
        .init();
