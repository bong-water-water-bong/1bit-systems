//! 1bit-agents — 17 specialists as an async dispatch table.
//!
...
/// override them; 1bit-mcp's `tools/list` surfaces the description + input
...
/// watcher integration in 1bit-core / 1bit-server.
