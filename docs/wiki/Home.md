...
Plain-English explanations of the architectural calls we made, kept aligned with the current Lemonade + FastFlowLM + `1bit-proxy` stack.
...
- [Complete pack](./Complete-Pack.md) — current live lanes and install entry point
- [Installation](./Installation.md) — current install and verification flow
...
- [Why this way + how?](./Why-This-Way-How.md) — current stack walkthrough

## Integrations

- [Lemonade compatibility](./Lemonade-Compat.md) — Lemonade on `:13305`; `1bit-proxy :13306` unifies it with FastFlowLM
