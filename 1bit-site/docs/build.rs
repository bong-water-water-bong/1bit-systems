...
fn build_sidebar(active: &str) -> String {
    let groups: &[(&str, &[(&str, &str)])] = &[
        ("decisions", &[
            ...
            ("Why 1bit-agents", "why-1bit-agents"),
        ...
        ("integrations", &[
            ...
            ("Whisper streaming", "1bit-whisper-streaming-plan"),
        ...
        ("crates", &[
            ("1bit-echo", "crate-1bit-echo"),
            ("1bit-helm", "crate-1bit-helm"),
            ("1bit-landing", "crate-1bit-landing"),
            ("1bit-lemonade", "crate-1bit-lemonade"),
            ("1bit-agents-watch", "crate-1bit-agents-watch"),
        ]),
        ("amd scans", &[
